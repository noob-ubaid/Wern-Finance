...
const Accordian = () => {
  return (
    <section className="lg:pt-20 md:pt-16 py-10 px-4 md:px-0">
      ...
      <Accordion className="max-w-screen-lg mx-auto mt-5 lg:mt-10 xl:mt-[64px]">
        {faqs.map(({ a, q }, i) => (
          <AccordionItem className="font-bold" key={i} aria-label={q} title={q}>
            <span className="text-[#ADB2B1] font-normal">{a}</span>
          </AccordionItem>
        ))}
      </Accordion>
    </section>
